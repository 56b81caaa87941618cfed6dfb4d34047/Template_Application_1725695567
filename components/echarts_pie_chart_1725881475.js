<!--
INSTRUCTION: To add this component to the user's app, you must follow all three of these steps:
INSTRUCTION: 1. In the html file, include `<echarts-pie-chart></echarts-pie-chart>` in the place where the chart needs to be inserted. Keep blank lines before and after this code. Do not remove the other components!
INSTRUCTION: 2. In the html file's <head> section, import the JS file for this component `./components/echarts-pie-chart.js`. You are strictly required to **NOT** remove anything else. Keep blank lines before and after this code. Do not remove the other component imports!
INSTRUCTION: 3. You are given the correct SQL statement -- replace the `PLACEHOLDER_SQL_STATEMENT` variable in this file with the actual SQL statement.
-->
